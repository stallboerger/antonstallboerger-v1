...
export const Footer = () => {
    return (
        <div className='w-full h-auto mb-20'>
            ...
            <p className="credits text-sm text-zinc-500 mb-2">&copy; Anton Stallbörger 2022. This website is hosted and deployed via <Link href='https://vercel.com/' target="_blank" className="hover:text-zinc-700">Vercel</Link>. Privacy-friendly Analytics by <Link href="https://vercel.com/analytics" target="_blank" className="hover:text-zinc-700">Vercel Analytics</Link>.</p>
