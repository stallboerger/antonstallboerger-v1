    ...
    return (
        <div className='w-full h-auto pt-[140px]'>
            <div className='max-w-[593px] h-full mx-auto flex flex-col px-4'>
                ...
                <br />
                <br />
                <Image src="/assets/projects/ups_app.webp" alt='UPS App Redesign' width="593" height="305" className='rounded-xl mb-2' priority='true'></Image>
                <br />
                ...
                <br />
                <br />
                <Image src="/assets/projects/comparisson.webp" alt='UPS App Redesign' width="593" height="305" className='rounded-xl mb-2' priority='true'></Image>
                <br />
                ...
                <br />
                <br />
                <Image src="/assets/projects/ups_app_screens.webp" alt='UPS App Redesign' width="593" height="305" className='rounded-xl mb-2' priority='true'></Image>
                <br />
