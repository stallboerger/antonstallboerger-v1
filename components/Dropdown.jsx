...
export default function Example() {
  return (
    <Menu as="div" className="relative inline-block text-left">
      ...
      >
      <Menu.Items className="absolute right-0 z-10 mt-4 w-auto origin-top-right divide-y divide-zinc-100 bg-white opacity-100 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none rounded-xl">
        <div className="py-2">
          <Menu.Item>
            {({ active }) => (
