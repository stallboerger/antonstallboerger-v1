    ...
    return (
        <div className='w-full h-auto pt-[140px]'>
            <div className='max-w-[593px] h-full mx-auto flex flex-col px-4'>
                ...
                />
                <br />
                <h3 className='text-2xl pb-2 text-zinc-900 dark:text-zinc-100'>Features</h3>
                ...
                />
                <br />
                <h3 className='text-2xl pb-2 text-zinc-900 dark:text-zinc-100'>Web Inspiration</h3>
                ...
                />
                <br />
                <h3 className='text-2xl pb-2 text-zinc-900 dark:text-zinc-100'>Interface</h3>
