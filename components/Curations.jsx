    ...
    return (
        <div className='w-full h-auto pt-[140px]'>
            <div className='max-w-[593px] h-full mx-auto flex flex-col px-4'>
                ...
                <br />
                <br />
                <Image src="/assets/projects/curations.webp" alt='' width="593" height="305" className='rounded-xl mb-2' priority='true'></Image>
                <br />
                ...
                <br />
                <br />
                <Image src="/assets/projects/ph_design_portfolio.webp" alt='' width="593" height="305" className='rounded-xl mb-2' priority='true'></Image>
                <br />
                ...
                <br />
                <br />
                <Image src="/assets/projects/ph_productivity_portfolio.webp" alt='' width="593" height="305" className='rounded-xl mb-2' priority='true'></Image>
                <br />
                ...
                <br />
                <br />
                <Image src="/assets/projects/featured_portfolio.webp" alt='' width="593" height="305" className='rounded-xl mb-2' priority='true'></Image>
                <br />
