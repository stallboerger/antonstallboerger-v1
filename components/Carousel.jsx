...
const Carousel = () => {
  ...
  return (
    <div className="relative pb-6 z-0">
      ...
      <button onClick={handlePreviousClick} className="top-[50%] absolute -translate-y-[50%] left-0 ml-4 rounded-full bg-zinc-50/75 p-2" aria-label="Left">
        <NavArrowLeft className="h-6 w-6 stroke-2 text-zinc-800" />
      </button>
      <button onClick={handleNextClick} className="top-[50%] absolute -translate-y-[50%] right-0 mr-4 rounded-full bg-zinc-50/75 p-2" aria-label="Right">
